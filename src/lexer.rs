...
impl Lexer {
    ...
    fn make_num(&self) -> Result<Token, String> {
    ...
    fn make_identifier(&self) -> Token {
        ...
        } else if let Some(ch) = self.current() {
            if *ch == '!' {
    ...
    fn make_str(&self, end: char) -> Result<Token, String> {
